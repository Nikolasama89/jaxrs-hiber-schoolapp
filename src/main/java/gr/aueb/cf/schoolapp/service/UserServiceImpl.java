...
public class UserServiceImpl implements IUserService{
    ...
    public UserReadOnlyDTO insertUser(UserInsertDTO dto) throws AppServerException {
        try {
            ...
            // ΑΝ ΔΩΣΕΙ EXCEPTION ΚΑΝΕΙ ROLLBACK
            JPAHelper.rollbackTransaction();
            LOGGER.info("User with username= {} inserted", dto.getUsername(), e);
            throw e;
        } finally {
    ...
    public UserReadOnlyDTO getUserByUsername(String username) throws EntityNotFoundException {
        try {
            ...
            LOGGER.info("User with username= {} not found", username, e);
            throw e;
        } finally {
            JPAHelper.closeEntityManager();
        }
    ...
    public boolean isEmailExists(String username) {
        try {
            ...
            boolean isMailExists = userDAO.isEmailExists(username);
            JPAHelper.commitTransaction();
            return isMailExists;
        }
        finally {

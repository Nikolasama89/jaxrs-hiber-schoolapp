...
public abstract class AbstractDAO <T extends IdentifiableEntity> implements IGenericDAO<T>{
    ...
    @Override
    public long count() {
        // ΕΔΩ ΓΙΝΕΤΑΙ ΧΡΗΣΗ ΤΟΥ JPQL. ΘΑ ΜΠΟΡΟΥΣΑΜΕ ΝΑ ΚΑΝΟΥΜΕ ΚΑΙ ΜΕ ΤΟ CRITERIA API
    ...
    public long getCountByCriteria(Map<String, Object> criteria) {
        ...
        // ΕΔΩ <> ΟΡΙΖΟΥΜΕ ΤΙ ΕΠΙΣΤΡΕΦΕΙ. ΣΤΗΝ ΠΕΡΙΠΤΩΣΗ ΜΑΣ LONG
    ...
    public Optional<T> getById(Object id) {
        EntityManager em = getEntityManager();
        // ΕΠΕΙΔΗ ΔΕΝ ΕΙΜΑΣΤΕ ΣΙΓΟΥΡΟΙ ΑΝ ΥΠΑΡΧΕΙ ΒΑΖΟΥΜΕ ofNullable
